!function(b, f) {
    ...
    return function(b) {
        function f(c) {
            ...
            return b[c].call(t.exports, t, t.exports, f),
            t.l = !0,
            t.exports
        }
        var e = {};
    ...
    , function(b, f, e) {
        ...
        var t = e(2)
          ...
          , I = {
            ...
            leapDays: function(b) {
                return I.leapMonth(b) ? 65536 & I.lunarInfo[b - 1900] ? 30 : 29 : 0
            },
            monthDays: function(b, f) {
                return f > 12 || f < 1 ? -1 : I.lunarInfo[b - 1900] & 65536 >> f ? 30 : 29
            },
            solarDays: function(b, f) {
                if (f > 12 || f < 1)
                    return -1;
                var e = f - 1;
                return 1 == e ? b % 4 == 0 && b % 100 != 0 || b % 400 == 0 ? 29 : 28 : I.solarMonth[e]
            },
            toGanZhi: function(b) {
            ...
            solar2lunar: function(b, f, e) {
                ...
                if (1900 == b && 1 == f && e < 31)
                    return -1;
                if (b)
                    var c = new Date(b,parseInt(f) - 1,e);
                else
                    var c = new Date;
                var t, a = 0, r = 0, b = c.getFullYear(), f = c.getMonth() + 1, e = c.getDate(), n = (Date.UTC(c.getFullYear(), c.getMonth(), c.getDate()) - Date.UTC(1900, 0, 31)) / 864e5;
                ...
                for (t = 1; t < 13 && n > 0; t++)
                    a > 0 && t == a + 1 && 0 == i ? (--t,
                    i = !0,
                    r = I.leapDays(l)) : r = I.monthDays(l, t),
                    1 == i && t == a + 1 && (i = !1),
                    n -= r;
                0 == n && a > 0 && t == a + 1 && (i ? i = !1 : (i = !0,
                --t)),
                n < 0 && (n += r,
                --t);
                var p = t
            ...
            lunar2solar: function(b, f, e, c) {
                ...
                if (b < 1900 || b > 2100 || e > a)
                    return -1;
                for (var r = 0, n = 1900; n < b; n++)
                    r += I.lYearDays(n);
                for (var d = 0, u = !1, n = 1; n < f; n++)
                    d = I.leapMonth(b),
                    u || d <= n && d > 0 && (r += I.leapDays(b),
                    u = !0),
                    r += I.monthDays(b, n);
                c && (r += a);
    ...
    , function(b, f, e) {
        ...
        f.default = ["日", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十"],
        b.exports = f.default
    }
    , function(b, f, e) {
        "use strict";
    ...
    , function(b, f, e) {
        ...
        f.default = ["零", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十"],
        b.exports = f.default
    }
    ])
});
